...
namespace DataLayer
{
    public class ContactRepository : IContactRepository
    {
        ...
        {
            return 
                this.db.Query<Contact>("SELECT * FROM Contacts WHERE Id = @Id", 
        ...
        {
            return
                this.db.Query<Contact>("select * from Contacts").ToList(); ;
        }
        ...
        public Contact GetFullContact(int id)
        {
            ...
            using (var multipleResults = this.db.QueryMultiple("GetContact",
                                            new { id },
        ...
        {
            return this.db.Query<Contact>("SELECT * FROM Contacts WHERE Id IN @Ids", 
                                    new { Ids = ids }).ToList();
        }

        public List<dynamic> GetDynamicById(params int[] ids)
        {
            return this.db.Query("SELECT * FROM Contacts WHERE Id IN @Ids", 
                                    new { Ids = ids }).ToList();
        }
